...
std::shared_ptr<Passage> Passage::createBasicPassage(Room* from, Room* to, const std::string &direction, bool locked = false, bool bidirectional = true) {
...
void Passage::setLocked(bool value) {
    locked = value;
}
